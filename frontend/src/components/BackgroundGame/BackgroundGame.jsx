...
const Background = ({gameId, setGameId, userId, resumeButtonDisabled, setResumeButtonDisabled}) => {
  ...
  return (
    <div className="background">
        ...
        {turn % 2 == 1 && win === 0 && <PopUpWaitingForOpponentMove turn={turn} setTurn={setTurn} opponentMoveList={opponentMoveList} setOpponentMoveList={setOpponentMoveList} gameId={gameId} setDisplayPopUpWin={setDisplayPopUpWin} setIsGameInProgress={setIsGameInProgress}/>}
